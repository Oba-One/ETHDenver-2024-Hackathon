...
export class CampaignToken extends ethereum.SmartContract {
  static bind(address: Address): CampaignToken {
    return new CampaignToken("CampaignToken", address);
  }
  ...
  createCampaign(
    ...
    _endDate: BigInt,
    _metadata: string,
    _capitals: Array<string>,
    _team: Array<Address>
  ): Address {
    let result = super.call(
      "createCampaign",
      "createCampaign(uint256,uint256,string,string[],address[]):(address)",
      [
        ...
        ethereum.Value.fromStringArray(_capitals),
        ethereum.Value.fromAddressArray(_team)
      ]
    );
...
export class ConstructorCall__Inputs {
  ...
  get _confirmationResolver(): Address {
...
export class CreateCampaignCall__Inputs {
  ...
  get _capitals(): Array<string> {
    return this._call.inputValues[3].value.toStringArray();
  }

  get _team(): Array<Address> {
